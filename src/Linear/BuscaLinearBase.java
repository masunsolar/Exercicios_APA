...
public class BuscaLinearBase {
    public static void executar() {
        ...
        for (int i = 0; i < vetor.length; i++) { // cria o vetor com números aleatórios e com o tamanho escolhido
            vetor[i] = gerador.nextInt(100) +1; // define o maior número que pode sair como 100 e ja adiciona 1 para o loop
        }

        System.out.println(Arrays.toString(vetor)); // mostra o vetor criado
        ...
        for (int i = 0; i < vetor.length; i++) {
            comparacoes++;
            if (vetor[i] == alvo) {
                posicao = i; // seta a posição do número
                achou = true;
                break;
            }
        }
